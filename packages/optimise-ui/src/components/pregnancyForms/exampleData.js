...
//         console.log('pregnancy outcome:',json);
//     })
//     .catch((error) => {
//         //dispatch(searchPatientFailure(searchString));
//         console.log('pregnancy outcome error:',error);
//     });

import { searchPatientAPICall } from '../../redux/actions/searchPatient';
