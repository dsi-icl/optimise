import {
    createPregnancyAPICall,
    editPregnancyAPICall,
    deletePregnancyAPICall,
    createPregnancyOutcomeAPICall,
    editPregnancyOutcomeAPICall,
    deletePregnancyOutcomeAPICall,
    createPregnancyImageAPICall,
    editPregnancyImageAPICall,
    deletePregnancyImageAPICall
} from '../../redux/actions/demographicData';
...
export function addEntryToPregnancy(pregnancyId, newEntry) {
    const template = {
        id: Math.random() * 5,
        pregnancyId: 1,
        date: '1612881504797.0',
