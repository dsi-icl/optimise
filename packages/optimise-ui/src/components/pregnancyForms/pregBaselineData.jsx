    ...
    render() {
        return (<>
            ...
            <div className={style.panel}>
                ...
                <label>Maternal age at LMP: <input defaultValue={this.state.maternalAgeAtLMP}/></label><br/><br/>
                <label>Maternal BMI: <input defaultValue={this.state.maternalBMI}/></label><br/><br/>
                ...
                <label>Assisted Reproductive Technology method:<br/>
                    <select defaultValue={this.state.ART}>
                ...
                <label>Number of foetuses: <input defaultValue={this.state.numOfFoetuses}/></label><br/><br/>
