    ...
    render() {
        ...
        return (
            <div className={style.profileActions}>
                <Link title="New visit" to={`/patientProfile/${patientId}/createVisit`}>
                    <Icon symbol="addVisit" />
                    <span>New visit</span>
                </Link>
                <Link title="Record test" to={`/patientProfile/${patientId}/create/test`}>
                    <Icon symbol="addTest" />
                    <span>Record test</span>
                </Link>
                <Link title="Record treatment" to={`/patientProfile/${patientId}/create/treatment`}>
                    <Icon symbol="addTreatment" />
                    <span>Record treatment</span>
                </Link>
                <Link title="Record event" to={`/patientProfile/${patientId}/create/clinicalEvent`}>
                    <Icon symbol="addEvent" />
