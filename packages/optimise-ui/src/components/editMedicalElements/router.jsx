...
import { EditVisit, EditTest, EditCE, EditMed, EditDemo, EditDiagnoses, EditPregnancies, EditCommunication, EditPerformanceMesaure, AddComorbidity } from './index';
    ...
    render() {
        return (
            <Switch>
                ...
                <Route path='/patientProfile/:patientId/edit/comorbidity/:visitId' render={({ match, location }) => <AddComorbidity match={match} location={location} />} />
