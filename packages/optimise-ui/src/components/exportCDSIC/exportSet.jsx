        ...
        return (
            <>
                ...
                <form className={style.panel}>
                    <span>You can data for all or a subset of your patients to a CDISC SDTM (Clinical Data Interchange Standards Consortium Study Data Tabulation Model) format by using the buttons below. To export for a subset, just enter your criteria on the left hand side.</span>
                    <br />
                    <br />
                    <span><i>CDISC SDTM is an open, multidisciplinary, neutral standard designed to facilitate the regulatory-compliant acquisition, archive and interchange of metadata and data for clinical research studies.</i></span>
                    <br />
                    <br />
                    <label>For all patient:</label>
                    <button onClick={this._handleExportAll}>Export summary</button>
                    <br />
                    <br />
                    <button onClick={this._handleExportAllCDISC}>Export as CDISC SDTM</button>
                    <br />
                    <br />
                    {result.length > 0
                        ? (
                            <>
                                ...
                                <button onClick={this._handleExport}>Export summary</button>
                                <br />
                                <br />
