        ...
        return <div className={scaffold_style.wrapper}>
            ...
            <div className={scaffold_style.list_element_panel}>
                <Switch>
                    ...
                    <Route path='/patientProfile/:patientId/visitFrontPage/:visitId/page/:currentPage/' render={({ match, location }) => <RenderTestWrapper match={match} location={location} displayThisType={1} tests={this.props.data.tests} />}/>
                </Switch>
            </div>
        </div>;
    }
