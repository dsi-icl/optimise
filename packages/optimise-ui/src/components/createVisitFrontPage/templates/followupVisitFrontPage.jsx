...
class FollowupVisitFrontPage extends Component {
    render() {
        ...
        const pageNumberToElementMap = {
            ...
            2: (
                <ComorbidityWrapper yesOrNoQuestion={(
                    <p>
                        Is there any
                        <b>newly diagnosed</b>
                        {' '}
                        ICD11-identified comorbidity since last visit?
                    </p>
                )}
                />
            ),
            ...
            4: (
                <ConcomitantMedWrapper yesOrNoQuestion={(
                    <>
                        <p>
                            Has the patient started any
                            <b>new</b>
                            {' '}
                            non-disease-modifying medication and/or supplements, or had
                            <b>any change</b>
                            {' '}
                            (including termination) thereof since last visit?
                        </p>
                        <br />
                ...
                <TreatmentWrapper
                    yesOrNoQuestion={(
                        <>
                            <p>
                                Is there any
                                <b>new disease-modifying treatments (DMT)</b>
                                ,
                                <b>DMT switch</b>
                                , or
                                <b>new immunosuppressive medication</b>
                                {' '}
                                since last visit.
                            </p>
                            <br />
                            <p>
                                To record a DMT switch,
                                <b>edit the previous treatment providing an &apos;end date&apos;, and then record a new treatment</b>
                                .
                            </p>
                        </>
                    )}
