...
function Treatment() {
    ...
    this.updateInterruption = Treatment.prototype.updateInterruption.bind(this);
...
Treatment.prototype.updateInterruption = function (user, idInterruption, updatedEntry) {
