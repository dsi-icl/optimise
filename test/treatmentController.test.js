...
describe('Create treatment controller tests', () => {
    ...
    test('Request creation with invalid time huge (should fail)', () => request
        .post('/api/treatments')
        .set('token', token)
        .send({
            'visitId': 11,
...
describe('Create treatment interruption controller tests', () => {
    ...
    test('Request treatment interuption with bad body (should fail)', () => request
        .post('/api/treatments/interrupt')
        .set('token', token)
        .send({ 'wrong': 1 })
        .then(res => {
...
describe('Delete treatment interruption controller tests', () => {
    ...
    test('Request deletion treatment interrupt with bad body (should fail)', () => request
        .delete('/api/treatments/interrupt')
        .set('token', token)
        .send({
            'wrong': 'bad',
