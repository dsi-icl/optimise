const exampleData = {
    ...
    'TREATMENTS': [
        { id: 1, orderedDuringVisit: 1, drug: 1, dose: 2, unit: 'cc', form: 'IV', times: 1, intervalUnit: 'year', createdByUser: 2, deleted: '-' },
        { id: 2, orderedDuringVisit: 3, drug: 4, dose: 2, unit: 'cc', form: 'IV', times: 2, intervalUnit: 'day', createdByUser: 2, deleted: '-' }
    ],
