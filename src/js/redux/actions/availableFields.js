...
export const APICall = (endpoint, cbDispatch) => {
    return () => {
        return (dispatch) => {
...
export const getVisitSectionsSuccess = (payload) => {
...
export const getDrugsSuccess = (payload) => {
...
export const getInterruptionReasonsSuccess = (payload) => {
...
export const getMeddraSuccess = (payload) => {
...
export const getPregnancyOutcomesSuccess = (payload) => {
...
export const getCEFieldsSuccess = (payload) => {
...
export const getDiagnosesSuccess = (payload) => {
...
export const getRelationSuccess = (payload) => {
...
export const getVisitFieldsSuccess = (payload) => {
...
export const getTestFieldsSuccess = (payload) => {
...
export const getClinicalEventTypesSuccess = (payload) => {
...
export const getTestTypesSuccess = (payload) => {
