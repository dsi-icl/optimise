            ...
            <div style={{ position: 'relative' }}>
                ...
                <div style={{ position: 'absolute', right: '2em' }}>
                    <NavLink to={`${window.location.pathname}/createVisit`} style={{ textDecoration: 'none' }}>
                        <div class='patientBanner UserActionButton' style={{ width: '1.7em', height: '2em', float: 'left', position: 'relative', right: 10 }}><AddVisitIcon width='1.7em'/></div>
                    </NavLink>
                    <div class='patientBanner UserActionButton' style={{ width: '1.7em', height: '2em', float: 'left' }}><AddTestIcon width='1.7em'/></div>
                    <div class='patientBanner UserActionButton' style={{ width: '1.7em', height: '2em', float: 'left' }}><AddTreatmentIcon width='1.7em'/></div>
                    <div class='patientBanner UserActionButton' style={{ width: '1.7em', height: '2em', float: 'left' }}><AddEventIcon width='0.6em' style={{ height: '1.7em' }}/></div>
                </div>
            </div>
        );
    }
